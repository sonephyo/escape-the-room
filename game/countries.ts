...
export const COUNTRIES: Record<CountryKey, CountryConfig> = {
  ...
  spain: {
    ...
    hotspots: [
      { id: "cafe", label: "El Café", xPct: 0.22, yPct: 0.7 },
      { id: "estacion", label: "Estación de tren", xPct: 0.6, yPct: 0.55 },
      { id: "sagrada", label: "Sagrada Família", xPct: 0.78, yPct: 0.4 },
      { id: "parkguell", label: "Park Güell", xPct: 0.35, yPct: 0.45 },
      { id: "alhambra", label: "Alhambra", xPct: 0.48, yPct: 0.3 },
  ...
  italy: {
    ...
    name: "Italy",
    locale: "it-IT",
    bg: "/countries/italy.png",
    hotspots: [
      { id: "gelato", label: "Gelato", xPct: 0.18, yPct: 0.7 },
      { id: "piazza", label: "Piazza", xPct: 0.5, yPct: 0.55 },
      { id: "duomo", label: "Duomo", xPct: 0.8, yPct: 0.3 },
    ],
  },
  usa: {
    key: "usa",
    ...
    hotspots: [
      ...
      { id: "grandcanyon", label: "Grand Canyon", xPct: 0.7, yPct: 0.5 },
      { id: "whitehouse", label: "White House", xPct: 0.25, yPct: 0.8 },
  ...
  germany: {
    ...
    name: "Germany",
    locale: "de-DE",
    bg: "/countries/germany.png",
    hotspots: [
      { id: "bakery", label: "Bäckerei", xPct: 0.3, yPct: 0.62 },
  ...
  nepal: {
    ...
    hotspots: [
      {
        id: "everest",
        label: "Mount Everest (Sagarmatha Region)",
        xPct: 0.18,
        yPct: 0.18,
      },
      {
        id: "pashupatinath",
        label: "Pashupatinath Temple (Kathmandu)",
        xPct: 0.78,
        yPct: 0.18,
      },
      ...
      {
        id: "boudhanath",
        label: "Boudhanath Stupa (Kathmandu)",
        xPct: 0.7,
        yPct: 0.45,
      },
  ...
  india: {
    ...
    hotspots: [
      ...
      {
        id: "varanasi1",
        label: "Varanasi Ghats (North)",
        xPct: 0.72,
        yPct: 0.48,
      },
      {
        id: "varanasi2",
        label: "Varanasi Ghats (South)",
        xPct: 0.7,
        yPct: 0.72,
      },
    ],
